import { vec3, mat3, mat4 } from './gl-matrix-module.js';
...
export class Renderer extends BaseRenderer {
    ...
    render(scene, camera) {
        ...
        this.device.queue.writeBuffer(cameraUniformBuffer, 0, cameraPosition);
        this.device.queue.writeBuffer(cameraUniformBuffer, 16, viewMatrix);
        this.device.queue.writeBuffer(cameraUniformBuffer, 80, projectionMatrix);
